...
public class TradingBroker {
	 ...
	 * @return ArrayList containing a bunch of Strings with the value of strategies previously used by the broker
	 */
	...
	/**
	 * This method will update the console when the broker ArrayList is updated
	 */
	public void update() {
